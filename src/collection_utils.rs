...
/// and collects them into a FxHashSet. This is a generic utility for path
/// collection operations. Automatically uses parallel processing for large
/// collections (>= 1000 items).
///
/// # Arguments
...
/// ```
pub fn collect_paths<T, F>(items: &[T], extractor: F) -> FxHashSet<String>
where
