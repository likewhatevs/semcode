...
impl FunctionStore {
    ...
    async fn insert_chunk(
        ...
        for func in functions {
            if func.body.is_empty() {
                ...
                body_hash_builder.append_value(crate::hash::compute_xxhash(&func.body));
            }
        }
    ...
    pub async fn get_all_bulk_optimized(&self) -> Result<Vec<FunctionInfo>> {
        ...
        let mut all_body_hashes = FxHashSet::default();
        let batch_size = 10000;
        let mut offset = 0;
    ...
    pub async fn get_by_names(&self, names: &[String]) -> Result<FxHashMap<String, FunctionInfo>> {
        if names.is_empty() {
    ...
    fn get_schema(&self) -> Arc<Schema> {
        Arc::new(Schema::new(vec![
            ...
            Field::new("body_hash", DataType::Utf8, true), // xxHash3 hash referencing content table as hex string (nullable for empty bodies)
