...
impl ProcessedFileStore {
    ...
    pub async fn get_all_git_file_shas(&self) -> Result<FxHashSet<String>> {
        use futures::TryStreamExt;
        ...
        let mut sha_set = FxHashSet::default();
        let mut processed_count = 0;
    ...
    pub async fn get_all_file_git_sha_pairs(&self) -> Result<FxHashSet<(String, String)>> {
        use futures::TryStreamExt;
        ...
        let mut pair_set = FxHashSet::default();
        let mut processed_count = 0;
